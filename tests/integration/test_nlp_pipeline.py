...
def test_basic_nlp_imports():
    ...
    try:
        ...
        from stoma.analysis.nlp_service import NLPService
        from stoma.analysis.nlp_storage import NLPStorage
...
def test_analysis_result_structure():
    ...
    try:
        from stoma.analysis.nlp_analyzer import AnalysisResult
